    ...
    public static class StatResolver {
        ...
        */
        public static StatBlock ApplyUserBonuses(StatBlock stats,
            ...
            if (tuning != null) {
                for (int i = 0; i < 4; i++) {
                    if (!tuning.TryGetValue(i, out var t)) continue;
        ...
        */
        ...
        Description   : Resolves 4-piece legendary combination against adjusted
                        ...
                        are applied after for final scoring.
        Parameters    : ArmorCandidate[]          legendaries      : 4 legendary candidates.
                        ArmorPiece                exotic           : Fixed exotic piece.
                        StatBlock                 originalMins     : User's original minimums.
                        StatBlock                 originalMaxs     : User's original maximums.
                        ...
                        Dictionary<ArmorSlot,int> fontCounts       : Font counts per slot.
                        Dictionary<ArmorSlot,int> advancedModEnergy: Advanced mod energy per slot.
                        int                       minorModCount    : Number of minor mods allowed.
                        Dictionary?               customTuning     : Custom tuning per legendary slot.
        Return Values : ResolvedResult                             : Resolved stats and score.
        */
        public static ResolvedResult Resolve(
            ...
            ArmorSlot[] slotOrder = [ArmorSlot.Helmet, ArmorSlot.Arms, ArmorSlot.Chestplate,
                                     ArmorSlot.Boots,  ArmorSlot.ClassItem];
            stats = ApplyStatMods(stats, adjustedMins, leastWanted,
                                  fontCounts, advancedModEnergy, minorModCount, slotOrder);
            ...
            StatBlock modded = new(stats.Health, stats.Melee, stats.Grenade,
                                   stats.Super,  stats.Class, stats.Weapons);
        ...
        Description   : Scores resolved stat block. Higher is better.
                        Penalizes focus usage & exceeding maximums.
